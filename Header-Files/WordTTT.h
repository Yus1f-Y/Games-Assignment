...
template<typename T>
class Word_toe_Random_player : public RandomPlayer<T>{
public:
    Word_toe_Random_player(T symbol);
    void getmove(int &x , int &y);
...
template <typename T>
Word_toe_Random_player<T>::Word_toe_Random_player(T symbol) : RandomPlayer<T>(symbol) {
    this->dimension = 3;
...
#include <ctime>   //
template <typename T>
void Word_toe_Random_player<T>::getmove(int& x, int& y) {
